...
** Last update Thu Apr 14 16:18:11 2016 John Doe
*/
				      ...
				      unsigned int color)
{
  ...
  double		angle;
  t_bunny_position	pos;
  t_bunny_position	dist2;

  angle = 0;
  dist2.x = dist->x - origin->x;
  dist2.y = dist->y - origin->y;
  radius = sqrt(pow(dist2.x, 2) + pow(dist2.y, 2));
  mini_radius = 1;
